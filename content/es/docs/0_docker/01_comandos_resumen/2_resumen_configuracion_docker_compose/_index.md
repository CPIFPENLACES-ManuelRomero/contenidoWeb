---
title: "Configuracion docker-compose-yaml"
...
{{% pageinfo %}}
### __:star: Comandos__  
 Fichero de configuración  __docker-compose.yaml__ 
 __docker-compose.yaml__ es un fichero de configuración que permite levantar sercicios en contenedores con el comando __docker compose up__, y apagarlos, eliminando los contenedores con el comando __docker compose down__
 {{% /pageinfo %}}
